...
// Type for deep modification of GameState properties - more flexible for testing
type DeepInvalidGameState = Partial<GameState> & Record<string, unknown>;
...
describe('validateGameState', () => {
  ...
  describe('bad numbers (NaN/Infinity/float)', () => {
    ...
    it('should throw with path when town resources contain NaN', () => {
      ...
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.resources!.fish = NaN;
      }
    ...
    it('should throw with path when town prices contain float', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prices!.wood = 1.5;
      }
    ...
    it('should throw with path when town prices contain negative value', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prices!.ore = -1;
      }
    ...
    it('should throw with path when town resources contain float', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.resources!.wood = 5.5;
      }
    ...
    it('should throw with path when town resources contain negative value', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.resources!.ore = -3;
      }
    ...
    it('should throw with path when town prices contain NaN', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prices!.fish = NaN;
      }
    ...
    it('should throw with path when town prices contain Infinity', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prices!.wood = Infinity;
      }
    ...
    it('should throw with path when town militaryRaw contains NaN', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.militaryRaw = NaN;
      }
    ...
    it('should throw with path when town militaryRaw contains Infinity', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.militaryRaw = Infinity;
      }
    ...
    it('should throw with path when town militaryRaw contains float', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.militaryRaw = 15.7;
      }
    ...
    it('should throw with path when town prosperityRaw contains NaN', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prosperityRaw = NaN;
      }
    ...
    it('should throw with path when town prosperityRaw contains Infinity', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prosperityRaw = Infinity;
      }
    ...
    it('should throw with path when town prosperityRaw contains float', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prosperityRaw = 20.3;
      }
  ...
  describe('unknown good ID in town maps', () => {
    it('should throw with path when town resources missing fish', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        delete (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.resources!.fish;
      }
    ...
    it('should throw with path when town prices missing wood', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        delete (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.prices!.wood;
      }
    ...
    it('should throw with path when town resources missing ore', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        delete (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.resources!.ore;
      }
  ...
  describe('missing required goods', () => {
    it('should throw with path when fish good is missing', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.goods) {
        delete (invalidState.goods as DeepModifiable<GameState['goods']>)!.fish;
      }
    ...
    it('should throw with path when wood good is missing', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.goods) {
        delete (invalidState.goods as DeepModifiable<GameState['goods']>)!.wood;
      }
    ...
    it('should throw with path when ore good is missing', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.goods) {
        delete (invalidState.goods as DeepModifiable<GameState['goods']>)!.ore;
      }
  ...
  describe('type validation', () => {
    it('should throw with path when turn is string', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      (invalidState as DeepModifiable<GameState>).turn = '0' as unknown;
    ...
    it('should throw with path when rngSeed is number', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      (invalidState as DeepModifiable<GameState>).rngSeed = 123 as unknown;
    ...
    it('should throw with path when towns is not array', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      (invalidState as unknown as Record<string, unknown>).towns = {};
    ...
    it('should throw with path when goods is not object', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      (invalidState as unknown as Record<string, unknown>).goods = [];
  ...
  describe('nested validation', () => {
    it('should throw with path when town id is missing', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        delete (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.id;
      }
    ...
    it('should throw with path when town revealed object is missing', () => {
      const invalidState = JSON.parse(JSON.stringify(validGameState)) as DeepInvalidGameState;
      if (invalidState.towns?.[0]) {
        delete (invalidState.towns[0] as DeepModifiable<GameState['towns'][0]>)!.revealed;
      }
